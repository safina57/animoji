    ...
    this.program = new Program(this.gl, {
      ...
      fragment: `
        ...
        void main() {
          ...
          gl_FragColor = vec4(color.rgb, color.a * shapeMask * uAlpha);
        }
      `,
      uniforms: {
        tMap: { value: texture },
...
class App {
  constructor(container, {
    ...
    font = 'bold 30px DM Sans', scrollSpeed = 2, scrollEase = 0.05,
    autoPlay = true, autoPlaySpeed = 0.4
  } = {}) {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: 'https://picsum.photos/seed/a1/800/600', text: 'Sample 1' },
      { image: 'https://picsum.photos/seed/a2/800/600', text: 'Sample 2' },
      { image: 'https://picsum.photos/seed/a3/800/600', text: 'Sample 3' },
      { image: 'https://picsum.photos/seed/a4/800/600', text: 'Sample 4' },
      { image: 'https://picsum.photos/seed/a5/800/600', text: 'Sample 5' },
      { image: 'https://picsum.photos/seed/a6/800/600', text: 'Sample 6' },
    ];
  ...
  update() {
    /* Auto-play: continuously advance scroll target unless user is dragging */
    if (this.autoPlay && !this.isDown) {
      this.scroll.target += this.autoPlaySpeed * 0.01;
    }
  ...
  addEventListeners() {
    ...
    /* Scope wheel events to the container so page scroll still works */
...
export default function CircularGallery({
  ...
  useEffect(() => {
    const app = new App(containerRef.current, {
      ...
      scrollSpeed, scrollEase, autoPlay, autoPlaySpeed
    });
    return () => app.destroy();
